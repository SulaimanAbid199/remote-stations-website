...
const competencies: CompetencyCard[] = [
  {
    ...
    memberImage: "/assets/team/member4.svg",
    name: "Umar Aziz",
  ...
  },
  {
    ...
    memberImage: "/assets/team/member6.svg",
  ...
  },
  {
    ...
    memberImage: "/assets/team/member1.svg",
  ...
  },
  {
    ...
    memberImage: "/assets/team/member3.svg",
    name: "Umer Saleem",
    domains: ["Azure", "AWS", "GCP", "Hetzner", "Digital Ocean"],
    slug: "umer-saleem",
  },
  ...
  },
  {
    ...
    memberImage: "/assets/team/member2.svg",
    name: "Sara Majid",
    slug: "sara-majid",
    domains: ["Azure", "AWS", "GCP", "Hetzner", "Digital Ocean"],
  },
...
function CompetencyCardHover({
  ...
  return (
    <div className="h-full">
      <Link href={`/team/${competency.slug}`}>
        <motion.div
          ...
          custom={custom}
          className="relative cursor-pointer flex flex-col bg-card rounded-3xl shadow-sm overflow-hidden h-full"
        ...
        >
          ...
          {/* HOVER CARD - Wahi original effect */}
          <div
            className={`
                  absolute inset-0 bg-[#0F0E0E] text-white rounded-3xl p-8 flex flex-col
