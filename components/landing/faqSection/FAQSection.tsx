...
const generalFaqs = [
  ...
  },
  {
    ...
    answer: `<strong>Cost-Effective:</strong> Avoid extra costs for office space, equipment, and long-term commitments. Benefit from no extra time charges, client-specific training, cross-domain support, and long-term partnership advantages.
...
const helpFaqs = [
  {
    ...
    answer: `<strong>Regular Meetings:</strong> Schedule daily or weekly check-ins to discuss progress and address any concerns.
...
<strong>Clear Expectations:</strong> Define project goals, timelines, and individual responsibilities to ensure everyone is aligned.`,
  },
  {
    ...
    answer: `<strong>Address Concerns Promptly:</strong> Communicate your concerns directly to the team or project manager to seek immediate resolution.
...
<strong>Contact Support:</strong> If issues persist, reach out to our support team for assistance in resolving the matter.`,
  },
  {
    ...
    answer: `<strong>Initial Contact:</strong> Reach out to our support team via email or phone with your issue.
...
<strong>Resolution:</strong> Our team will work diligently to resolve the issue and keep you informed throughout the process.`,
  },
  {
    ...
    answer: `<strong>Evaluate Needs:</strong> Determine the additional skills and resources required.
<strong>Request Additional Resources:</strong> Contact us to discuss scaling options, and we will provide suitable candidates to meet your needs.`,
  },
  {
    ...
    answer: `<strong>Notify Us:</strong> Inform our support team about the replacement requirement.
...
export default function FAQSection() {
  ...
  const toggleAccordion = (index: number) => {
    if (openQuestion?.tab === activeTab && openQuestion.index === index) {
      setOpenQuestion(null);
    } else {
      setOpenQuestion({ tab: activeTab, index });
    }
  };
  ...
  return (
    <section className="max-w-[1600px] mx-auto px-4 md:px-0">
      <AnimatedText
        as="h2"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
        ...
        >
          {faqs.map((item, index) => {
            const isOpen =
              openQuestion?.tab === activeTab && openQuestion.index === index;
