      ...
      >
        <div className="lg:ml-30 rounded-2xl overflow-hidden relative">
          <div className="relative group">
            ...
            <motion.button
              className="absolute bottom-20 left-1/2 -translate-x-1/2 bg-white/30 text-white px-4 py-3 rounded-full font-semibold text-md shadow-md flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-500 z-20 cursor-pointer"
              onClick={() => router.push("/contact")}
